...
"""
    ...
    print(
        "You should now be able to search for 'PrayerTimer' in your application menu with your custom icon."
    )

    # 6. Ask about Auto-Start
    autostart = (
        input("\nDo you want PrayerTimer to start automatically when you log in? (y/n): ")
        .strip()
        .lower()
    )
